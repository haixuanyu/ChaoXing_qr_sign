#省流
  调学习通接口的纯前端项目（根本不需要担心账号风险，因为根本不上传账号，无需维护长期有效），签到使嘎嘎好用。主播已经用了快一个学年了，一点毛病没有，能拿来位置签到和扫码签到（至少需要一个义父去扫全班能签上），过两天给其他的一些奇形怪状的其他不常用签到更了。建议点个ｓｔａｒ好获取更新信息，除了怕老师人脸识别ｇａｎｋ基本上没啥缺点了，想下的直接去[Releases 发布页](https://github.com/haixuanyu/ChaoXing_qr_sign/releases)的
ａｐｋ下就完了
